...
function promptName() {
  let value = prompt("WELCOME TO DOTA, WRITE YOUR NICKNAME");
  while (value == ""){
      value = prompt("Enter your NICKNAME TRASH");
  }
...
function Win(){
  document.getElementById("hit").style.display= alert("YOU ARE PRO PLAYER"); 
}
function Win1(){
document.getElementById("lasthit").style.display=alert("YOU ARE NOOB");
}
